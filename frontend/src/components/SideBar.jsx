	...
	return (
		<div className='h-screen w-screen flex absolute z-50'>
			<div className="h-screen w-full sm:w-1/4 bg-gray-900 overflow-auto">
				...
				<ol>
					<li className='text-white  p-2 text-left flex items-center mb-2 hover:bg-violet-800 hover:cursor-pointer '><img src="https://tuk-cdn.s3.amazonaws.com/assets/components/testimonials/t_1.png" alt="card" className="min-h-8 min-w-8 mr-1 object-cover overflow-hidden rounded-full border-4 z-20"/><span className='truncate'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis, natus.</span></li>
					<li className='text-white  p-2 text-left flex items-center mb-2 hover:bg-violet-800 hover:cursor-pointer '><img src="https://tuk-cdn.s3.amazonaws.com/assets/components/testimonials/t_1.png" alt="card" className="min-h-8 min-w-8 mr-1 object-cover overflow-hidden rounded-full border-4 z-20"/><span className='truncate'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis, natus.</span></li>
					<li className='text-white  p-2 text-left flex items-center mb-2 hover:bg-violet-800 hover:cursor-pointer '><img src="https://tuk-cdn.s3.amazonaws.com/assets/components/testimonials/t_1.png" alt="card" className="min-h-8 min-w-8 mr-1 object-cover overflow-hidden rounded-full border-4 z-20"/><span className='truncate'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis, natus.</span></li>
					<li className='text-white  p-2 text-left flex items-center mb-2 hover:bg-violet-800 hover:cursor-pointer '><img src="https://tuk-cdn.s3.amazonaws.com/assets/components/testimonials/t_1.png" alt="card" className="min-h-8 min-w-8 mr-1 object-cover overflow-hidden rounded-full border-4 z-20"/><span className='truncate'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis, natus.</span></li>
					<li className='text-white  p-2 text-left flex items-center mb-2 hover:bg-violet-800 hover:cursor-pointer '><img src="https://tuk-cdn.s3.amazonaws.com/assets/components/testimonials/t_1.png" alt="card" className="min-h-8 min-w-8 mr-1 object-cover overflow-hidden rounded-full border-4 z-20"/><span className='truncate'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis, natus.</span></li>
			...
			<div className="h-screen w-0 sm:w-3/4 bg-black opacity-50 "></div>
