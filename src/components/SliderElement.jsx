...
function SliderElement({key, city, country,image}) {
  return (
		<LinkRouter to={"/detail/"+city} className="flex justify-center items-center">
			<div key={key} className="max-w-sm xl:max-w-md 2xl:max-w-5xl rounded-lg border shadow-md m-1 hover:animate-pulse relative ">
